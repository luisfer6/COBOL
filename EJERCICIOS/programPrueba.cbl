      ...
      *-----------------------
       ...
       01  WS-TOTALES-DIARIOS.
           05 WS-HORAS                     PIC 9(03) VALUE 0.

           01  WS-TOTALES-SEMANALES.
           05 WS-HORAS                     PIC 9(03) VALUE 0.

           01  WS-TOTALES-MENSUALES.
           05 WS-HORAS                     PIC 9(03) VALUE 0.
      ...
      *     '12345678901234567890123456789012345678901234567890'
       ...
       77  WS-STRING-SALIDA         PIC X(50) VALUE ' '.
      ...
      *    DISPLAY 'WS-STRING(20:10): ' WS-STRING(20:10).
      *    DISPLAY 'WS-STRING(30:20): ' WS-STRING(30:20).
           DISPLAY 'WS-STRING-SALIDA: ' WS-STRING-SALIDA.

           PERFORM VARYING WS-INDICE FROM 1 BY 1
             UNTIL WS-INDICE > 50
                   EVALUATE WS-STRING(WS-INDICE:1)
                       WHEN  'A'
                             MOVE '*' TO WS-STRING-SALIDA(WS-INDICE:1)
                       WHEN  'H'
                             MOVE '%' TO WS-STRING-SALIDA(WS-INDICE:1)
                       WHEN OTHER
                       MOVE ' ' TO WS-STRING-SALIDA(WS-INDICE:1)
           ...
           ADD 1             TO WS-HORAS IN WS-TOTALES-DIARIOS.

           ADD WS-HORAS IN WS-TOTALES-DIARIOS
                             TO WS-HORAS IN WS-TOTALES-DIARIOS.

           ADD WS-HORAS IN WS-TOTALES-SEMANALES
                             TO WS-HORAS IN WS-TOTALES-SEMANALES.

               ADD WS-HORAS IN WS-TOTALES-MENSUALES
                             TO WS-HORAS IN WS-TOTALES-MENSUALES.
